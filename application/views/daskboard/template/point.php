 <div style="background-color: #660066; width: 100%; height: 80px;  position: relative; top: 0px; z-index: 0;"></div>
  ...
  <div class="header-text" id="top">
    ...
    <div class="container-fluid" >
        <div>
          <button data-toggle="modal" data-target="#exampleModal" style="position: absolute; top: 170px; left: 26px; z-index: 1; background: white; border-radius: 4px; border-color: #C2BFBA;">
                        <i class="fas fa-map"></i>
          </button>

           <div id="map_h"  style="width: 100%; height: 560px;  position: relative; top: 10px; z-index: 0;">
           </div>
      </div>
    </div>
