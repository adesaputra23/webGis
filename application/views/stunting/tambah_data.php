   ...
   <h1 class="h5 mb-0 text-gray-800">Tambah Data Stunting</h1>
	...
	<div class="card mb-4">
        <div class="card-header">
             Form Tambah Data
             <a style="float: right;" href="<?= base_url('data_stunting/staf/').$this->fungsi->user_login()->kode_wilayah?>" class="btn btn-secondary btn-icon-split btn-sm">
        	 				...
        	 				<div class="col-6">
	                    		...
	                    		<div class="form-group">
								  ...
								  <div>
								    ...
								    <small class="text-success">Biarkan kosong jika tidak ingin di tambah</small>
								    </div>
								 </div>
								  <div class="form-group mt-3">
								   <select readonly class="form-control <?=form_error('kecamatan') ? 'is-invalid' : null?>" id="kecamatan" name="kecamatan">
								      		<option  value="<?= $this->fungsi->user_login()->kode_wilayah?>" <?=set_value('kecamatan') == $this->fungsi->user_login()->kode_wilayah?> ? "selected" : null ?><?= $this->fungsi->user_login()->nama_wilayah?></option>
								    </select>
