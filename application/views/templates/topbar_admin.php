            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <?php if ($this->session->userdata('level') == '6') { ?>
                  <span class="mr-3 mt-1 d-none d-lg-inline text-gray-600 small"><b>Puskesmas : <?= $this->fungsi->user_login()->puskesmas?></b></span>
                   <span class="mr-3 mt-1 d-none d-lg-inline text-gray-600 small">| <?= $this->fungsi->user_login()->email?><br>| <b><?= $this->fungsi->user_login()->nama ?></b></span>
                 
                <img class="img-profile rounded-circle" src="<?= base_url('assets/');?>img/<?= $this->fungsi->user_login()->gambar?>">
              <?php  } else{ ?>
                  <span class="mr-3 mt-1 d-none d-lg-inline text-gray-600 small">| <?= $this->fungsi->user_login()->email?><br>| <b><?= $this->fungsi->user_login()->username?></b></span> 
